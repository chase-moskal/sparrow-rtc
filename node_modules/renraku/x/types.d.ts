...
export declare const is_service: unique symbol;
...
export declare type MetaMap<xApi extends Api> = {
    [P in keyof xApi]: xApi[P] extends Service<infer xMeta, any, Methods> ? () => Promise<xMeta> : xApi[P] extends Api ? MetaMap<xApi[P]> : never;
};
export declare type AuthMap<xApi extends Api> = {
    [P in keyof xApi]: xApi[P] extends Service<any, infer xAuth, Methods> ? () => Promise<xAuth> : xApi[P] extends Api ? AuthMap<xApi[P]> : never;
};
export declare type ApiRemote<xApi extends Api> = {
    [P in keyof xApi]: xApi[P] extends Service<any, any, infer xMethods> ? xMethods : xApi[P] extends Api ? ApiRemote<xApi[P]> : never;
};
export declare type Remote<X extends Service<any, any, any> | Api> = X extends Service<any, any, infer xMethods> ? xMethods : X extends Api ? ApiRemote<X> : never;
