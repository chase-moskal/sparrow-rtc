...
export function getValidatedCommandLineArguments(commander) {
    const { port, open, label, origin, cynicPath, importmapPath, } = commander;
...
//# sourceMappingURL=get-validated-command-line-arguments.js.map